    ...
    <div className="h-16 bg-blue-500  z-50 flex items-center sticky top-0 ">
      <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
        ...
        >
          ...
          {!token && (
            <Link to="/register">
              <li className=" sm:ml-0 -ml-1 bg-white text-blue-500 cursor-pointer w-24 text-center font-semibold px-2 py-2 rounded-md  hover:text-slate-300   transition-all duration-150">
                SignUp
              </li>
            </Link>
            )}
          ...
          {token && (
            <button
             ...
             className="sm:ml-0 -ml-1 bg-white text-blue-500  cursor-pointer w-24 text-center font-semibold px-2 py-2 rounded-md  hover:text-slate-300   transition-all duration-150">
              LogOut
            </button>
            )}
        </ul>
